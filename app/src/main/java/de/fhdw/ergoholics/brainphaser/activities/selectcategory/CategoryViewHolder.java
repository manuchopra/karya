...
public class CategoryViewHolder extends RecyclerView.ViewHolder {
    ...
    public CategoryViewHolder(View itemView, CategoryAdapter.SelectionListener selectionListener) {
        ...
        mMoneyMade = (TextView) itemView.findViewById(R.id.moneyMade);
    }
...
//        });
    ...
    private void updateDueCounter(int amountDue) {
        if (amountDue > 0) {
            ...
            int moneyMade = (int) ((12 -amountDue)*0.5);
            mDueCountText.setText(itemView.getResources().getQuantityString(R.plurals.challenges_due, amountDue, amountDue));
            if (moneyMade >= 4){
                moneyMade = 4;
            }
            mMoneyMade.setText(itemView.getResources().getQuantityString(R.plurals.moneyMade,moneyMade,moneyMade));
        } else {
            ...
            mMoneyMade.setText("You did it! You are done!");
        }
    }
