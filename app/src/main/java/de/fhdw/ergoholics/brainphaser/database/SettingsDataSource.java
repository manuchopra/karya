...
public class SettingsDataSource {
    ...
    public void setToDefaultSettings(Settings settings) {
        settings.setTimeBoxStage1(new Date(Period.weeks(1).toStandardDuration().getMillis()));
        settings.setTimeBoxStage2(new Date(Period.weeks(2).toStandardDuration().getMillis()));
        settings.setTimeBoxStage3(new Date(Period.weeks(4).toStandardDuration().getMillis()));
        settings.setTimeBoxStage4(new Date(Period.weeks(10).toStandardDuration().getMillis()));
        settings.setTimeBoxStage5(new Date(Period.weeks(20).toStandardDuration().getMillis())); // a Month
